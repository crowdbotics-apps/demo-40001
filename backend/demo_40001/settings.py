"""
Django settings for demo_40001 project.
...
WSGI_APPLICATION = 'demo_40001.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40001 API",
    "DESCRIPTION": "API documentation for demo_40001 App",
    "VERSION": "v1",
}
